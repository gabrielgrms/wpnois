...
<?php if( 'page' == get_option( 'show_on_front' ) ): ?>
	...
	<?php
		...
		if( 'no' != get_theme_mod('bizto_show_services') ){
			
			if( 'two' == get_theme_mod('bizto_service_layout') ){
				...
				<div class="front-page-post">
					...
					<?php
						if ( has_post_thumbnail() ) {
							...
							echo '<img src="' . get_template_directory_uri() . '/assets/images/service-0' . rand(1, 5) . '.jpg" />';
						}						
					?>
